...
import * as d_docs_3 from "../content/docs/api/authentication.mdx?collection=docs";
import * as d_docs_2 from "../content/docs/quick-start.mdx?collection=docs";
import * as d_docs_1 from "../content/docs/installation.mdx?collection=docs";
...
export const docs = _runtime.docs<typeof _source.docs>(
  [
    ...
    {
      info: { path: "installation.mdx", fullPath: "content/docs/installation.mdx" },
      data: d_docs_1,
    },
    { info: { path: "quick-start.mdx", fullPath: "content/docs/quick-start.mdx" }, data: d_docs_2 },
    {
      info: { path: "api/authentication.mdx", fullPath: "content/docs/api/authentication.mdx" },
      data: d_docs_3,
    },
    { info: { path: "api/index.mdx", fullPath: "content/docs/api/index.mdx" }, data: d_docs_4 },
  ...
  [
    ...
    {
      info: { path: "api/meta.json", fullPath: "content/docs/api/meta.json" },
